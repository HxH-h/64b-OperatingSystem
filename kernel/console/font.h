...
// 128个ASCII字符的16x8点阵字体数据
// 每个字符16行，每行8列(1字节)

// 字体数据定义
const unsigned char font_ascii[128][16] = {
    // ASCII 0 (NULL)
    {
    ...
    // ASCII 34 (")
    {
        0x00, 0x00, 0x66, 0x66, 0x24, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
    },
    ...
    // ASCII 48 (0)
    {
        0x00, 0x00, 0x3C, 0x66, 0xC2, 0xC6, 0xCE, 0xDE,
        0xF6, 0xE6, 0x66, 0x3C, 0x00, 0x00, 0x00, 0x00
    },
    ...
    // ASCII 65 (A)
    {
        0x00, 0x00, 0x10, 0x30, 0x38, 0x3C, 0x36, 0x36,
        0x36, 0x7C, 0x6C, 0xCE, 0x00, 0x00, 0x00, 0x00
    },
    ...
    // ASCII 72 (H)
    {
        0x00, 0x00, 0xCE, 0xCE, 0xCE, 0xCE, 0xFE, 0xCE,
    ...
    // ASCII 88 (X)
    {
        0x00, 0x00, 0xC6, 0xC6, 0x6C, 0x6C, 0x38, 0x10,
    ...
    // ASCII 106 (j)
    {
        ...
        0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x78, 0x00
    },
    ...
    // ASCII 116 (t)
    {
        0x00, 0x00, 0x00, 0x60, 0x60, 0xF8, 0x60, 0x60,
